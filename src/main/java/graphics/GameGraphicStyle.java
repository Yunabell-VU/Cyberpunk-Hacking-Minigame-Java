...
public interface GameGraphicStyle {
    ...
    static void
    styleCodeMatrixPanel(JPanel panel, int matrixSpan){
    ...
    static void
    styleMatrixCellButton(JButton button){
    ...
    static void
    styleDaemonCellLabel(JLabel label){
        label.setForeground(ColorFactory.createColor("theme"));
    ...
    static void
    styleDaemonCellNotAdded(JLabel label){
        label.setForeground(Color.WHITE);
    }

    static void
    styleDaemonCellSelected(JLabel label){
        label.setBorder(BorderFactory.createLineBorder(ColorFactory.createColor("theme")));
    }

    static void
    styleDaemonsPanel(JPanel panel){
    ...
    static void
    styleDaemonPanel(JPanel panel){
        panel.setBounds(560,200,550,350);
        panel.setOpaque(false);
    }

    static void
    styleResultLabel(JLabel label){
    ...
    static void
    styleMenuBarPanel(JPanel panel){
    ...
    static void
    styleUndoCDPanel(JPanel panel){
        panel.setBounds(650,530,40,40);
        panel.setOpaque(false);
        panel.setLayout(new FlowLayout(FlowLayout.CENTER, 0, 0));
    }
    static void
    styleUndoCDLabel(JLabel label){
        label.setPreferredSize(new Dimension(40,40));
        label.setForeground(ColorFactory.createColor("theme"));
        label.setFont(FontFactory.createFont(25));
    }
    ...
    static void
    styleTimeLimitPanel(JPanel panel){
        panel.setOpaque(false);
        panel.setBounds(432, 63, 85, 52);
    }

    static void
    styleTimeOutPanel(JPanel panel){
    ...
    static void
    styleTimeOutLabel(JLabel label){
